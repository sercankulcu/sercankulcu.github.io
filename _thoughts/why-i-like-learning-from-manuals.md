...
This is one reason systematic reading can feel slower while producing a different kind of speed later. It builds a map rather than only pointing to one destination. When a new problem appears, I may not remember the exact answer, but I remember that a certain region of the tool exists and where to look.

Repeated use can make an incomplete understanding feel sufficient. Documentation interrupts that familiarity by showing how the system describes itself rather than how I happened to learn it.
...
Sometimes I need the answer in thirty seconds. Search is often enough. Sometimes a tool has become important enough that I want to understand its shape, not only today's error message. Then I want the manual.
...
That does not make manuals superior to search. They address different gaps in understanding.
