...
Some pencils become famous because artists adopt them. Others become famous because almost everyone meets one before they know enough to care about pencils.
...
The HB version is the natural reference point. In school use, a pencil has to make a sufficiently dark mark without wearing down too quickly, survive sharpening by users with very different habits, and tolerate being dropped. A technically impressive core is useless in a classroom if it fractures repeatedly inside the wood.

STAEDTLER emphasizes this durability in the current Noris 120 through what it calls a super-bonded lead. The core is bonded to the surrounding body to improve break resistance. The idea is familiar across quality wooden pencils: the lead and casing should behave as one structure rather than as a loose brittle rod trapped inside wood.
...
The red end deserves attention as well. It is not an eraser. On the classic Noris, the red section acts as a visual termination point and helps complete the black-yellow-red color scheme. That makes it different from American school pencils, where the opposite end is often dominated by a metal ferrule and eraser. Noris expresses identity through paint rather than an attached component.

This gives the pencil a distinctly different silhouette from a Dixon Ticonderoga or Eberhard Faber Mongol. All three can occupy the same everyday-school category, but they communicate it differently. The American tradition often emphasizes yellow lacquer, ferrule, and eraser. Noris uses bold stripes and an untipped end. The comparison shows that “school pencil” is not one universal visual design.

The Noris also demonstrates how a brand can expand without losing its anchor. Today the Noris name appears across pencils, colored pencils, crayons, sharpeners, compasses, and products for early writing practice. Yet the striped graphite pencil remains the clearest expression of the brand.

That continuity is probably more important than rarity.

Most Noris pencils were made to be used, sharpened, lost, replaced, and bought again. They are not scarce objects in the usual collector sense. Their value lies in showing how a mass-produced design can remain legible across generations.

A rare pencil can survive because people protect it.

A Noris survives because manufacturers keep making it and users keep recognizing it.

After 125 years, that may be the harder achievement.
