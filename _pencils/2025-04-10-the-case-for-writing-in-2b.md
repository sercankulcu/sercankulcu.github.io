...
Smudging is another tradeoff. Because a 2B leaves more loose graphite on the surface, fresh writing can transfer to the side of the hand or the opposite page of a notebook. Left-handed writers may notice this more strongly because the writing hand often passes directly over recent marks.

That does not mean 2B is inherently messy. Core formulation matters. Some 2B pencils feel dry and controlled, while others are very soft, waxy, or powdery. Paper sizing and surface texture also change how securely graphite stays in place. A controlled test across several brands is more useful than assuming all 2B pencils behave alike.
...
Margin notes and compact annotations are where 2B becomes less ideal. As the point rounds, small characters can lose definition. In those cases, a firm B, HB, or mechanical pencil may be more efficient. The case for 2B is strongest when readability and relaxed pressure matter more than maximum point life.

Speed writing is another interesting use. During lectures or meetings, a softer pencil can create a legible mark with minimal force, allowing the hand to move quickly. The disadvantage is that fast writing with a blunt point can become broad, so rotation and occasional sharpening remain important.
...
A useful comparison set is HB, B, and 2B from the same series. Write the same sentence with each grade at normal pressure, then repeat with deliberately light pressure. Compare darkness, line width, point wear, smudging, and erasing. Many people discover that the grade they prefer for writing is not the one they expected.

The best 2B for everyday writing is not necessarily the darkest. A very soft drawing-oriented 2B can blunt too quickly. A slightly firmer 2B with good point retention may be more practical because it preserves the low-pressure advantage without becoming broad after a few lines.

This is why writing in 2B makes a strong case for itself. It offers a dark, readable line, encourages a lighter hand, and gives handwriting a more expressive surface than many harder grades. The tradeoffs—faster wear, more frequent sharpening, and greater smudging—are real, but they can be managed.

For anyone who thinks wooden pencils feel pale, scratchy, or tiring, trying a good 2B is one of the simplest experiments available. The problem may not be the pencil as a medium. It may be that the default grade was never the best match for the way that person writes.
