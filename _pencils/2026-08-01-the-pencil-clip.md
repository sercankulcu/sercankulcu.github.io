...
A 1925 patent by William J. White describes the problem directly: the pencil had to be inserted and removed quickly while remaining secure against accidental withdrawal. The design also had to be small, inexpensive, and unlikely to tear fabric, explaining the preference for thin spring metal, rounded edges, and stamped shapes.

Detachable clips required no redesign of the pencil. A standard round or hexagonal barrel could remain unchanged, and the clip could move from one pencil to the next as the first was consumed. The pencil shortened with sharpening; the accessory survived.
...
The clip itself can be collectible. Maker names, patent numbers, plated finishes, spring shapes, decorative shields, and advertising text can help identify period and origin. Some were promotional objects; others were generic stationery accessories that outlived the pencils they originally held.

Wear provides useful evidence. Lost plating suggests rubbing against fabric or fingers, residue inside the band may come from lacquer or corrosion, and a badly opened spring can indicate use on an oversized pencil.

Corrosion is a particular concern when storing vintage clips on vintage pencils. Bare or rusting steel can stain lacquer and wood, while sharp oxidized edges can scratch the barrel. Long-term storage is usually safer when the clip and pencil are documented together but physically separated, especially if the clip already shows active corrosion. A small accessory should not be allowed to damage the more fragile object it is meant to accompany.

The pencil clip never became universal because most school and desk pencils did not need one. Built-in clips made more sense on reusable pens and mechanical pencils, while a detachable accessory preserved the low cost of a wood-cased pencil and added pocket carry only when needed.

That is what makes the pencil clip an interesting collector object. It sits between stationery and clothing hardware, between permanent tool and disposable pencil, and between factory design and user customization. A few grams of bent spring metal could change where a pencil lived, how it was carried, and whether it survived a working day without being lost.
